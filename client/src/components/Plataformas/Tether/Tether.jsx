  ...
  return (
    <div className={styles.Bitcoin}>
      ...
      <div className={styles.descripcionBitcoin}>
        <h1>TETHER</h1>
        <span>
          <strong>DESCARGO DE RESPONSABILIDAD DEPOSITOS EN USDT DE LA RED TRC20:</strong> ANTES DE RECIBIR TUS TETHER NUNCA DEBES OLVIDAR TENER EN CUENTA LAS SIGUIENTES RECOMENDACIONES:
        </span>
        <p>
