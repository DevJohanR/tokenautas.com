  ...
  return (
    <div className={styles.Bitcoin}>
      ...
      <div className={styles.descripcionBitcoin}>
        <h1>BITCOIN</h1>
        <span><strong>DESCARGO DE RESPONSABILIDAD PARA DEPÓSITOS EN BITCOIN (BTC):</strong> ANTES DE RECIBIR TUS BITCOIN NUNCA DEBES OLVIDAR TENER EN CUENTA LAS SIGUIENTES RECOMENDACIONES:</span>
